...
const currentExecutives = [
  { name: 'Sabrine Djebbar', image: '/images/executives/sabrine-djebbar.png', bio: "Hey! I'm Sabrine and I'm in HHS. I'm interested in all things biology, baking, and chemistry!" },
  { name: 'Lauren Engo', image: '/images/executives/lauren-engo.png', bio: "Hai!! I'm Lauren and I'm in P&A. I'm passionate about computer science and environmental engineering." },
  { name: 'Nicolas Huni', image: '/images/executives/nicolas-huni.png', bio: "Hi, I'm Nic! I'm in Health Science and I find genetics, herpetology, venomics and nuclear chemistry really interesting." },
  { name: 'Airan Zhang', image: '/images/executives/airan-zhang.jpg', bio: "Hi! I'm Airan and I'm in Health. Maybe you've met me last semester at MRT pins fundraising. I'm interested in almost anything remotely scientific, but I have a special spot for pharmacognosy." },
  { name: 'Sumin Woo', image: '/images/executives/sumin-woo.png', bio: "Hi! I'm Sumin and I'm passionate about research and science." },
  { name: 'Zhi Cheng Ma', image: '/images/executives/zhicheng-ma.png', bio: "Hello! I'm Zhi Cheng and I'm interested in various scientific fields." },
];
    ...
    <div className="space-y-4">
      {pastExecutives.map((yearData) => (
        <div key={yearData.year} className="bg-white rounded-xl shadow-md overflow-hidden">
          <button
            onClick={() => setOpenYear(openYear === yearData.year ? null : yearData.year)}
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-semibold text-primary">{yearData.year} Executive Team</span>
            </div>
            <motion.div
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="space-y-16">
            ...
            <div className="relative max-w-4xl mx-auto text-center px-4">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-secondary">
                  Meet the passionate team behind Marianopolis Research Team and learn about our journey
                </p>
              </motion.div>
            </div>
          </section>
          ...
          <section id="about-story" className="bg-white">
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                MRT is a club that hopes to foster the development of an interconnected community at Marianopolis focused on scientific innovation and research. Whether it be through open collaboration with other clubs or through interesting seminars and roundtable discussions, we wish to spark interest in young talents across the campus to adorn in (hopefully!) ground-breaking research that will tackle issues close to heart.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Through our yearly research projects, workshops, seminars, and collaborative events, we
                empower students to explore their scientific interests, develop critical research skills,
                and contribute meaningfully to the scientific community.
              </p>
            </motion.div>
          </section>

          {/* Current Executives */}
          <section id="about-executives" className="bg-surface rounded-3xl p-8 md:p-10">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
            >
              <h2 className="text-4xl font-bold text-primary mb-4 text-center">Current Executive Team</h2>
              <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
                Meet the dedicated individuals leading MRT into the future
              </p>
                ...
                {currentExecutives.map((exec, index) => (
                  ...
                  >
                    ...
                    <div className="p-6 text-center">
                      <h3 className="text-xl font-bold text-primary mb-3">{exec.name}</h3>
                      <p className="text-sm text-gray-600 leading-relaxed">{exec.bio}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
          ...
          <section id="about-past" className="bg-white">
            ...
            >
              <h2 className="text-4xl font-bold text-primary mb-4 text-center">Past Executive Teams</h2>
              <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          ...
          >
            ...
            >
                ...
                {[
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-secondary text-sm">{social.handle}</p>
                    </motion.a>
                  );
                })}
              </div>
              ...
              <div className="mt-12">
                <p className="text-secondary mb-4">Interested in joining the team?</p>
                <motion.a
                  href="/research/"
